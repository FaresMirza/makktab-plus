...
export class CreateTaskAuditLogDto {
  @ApiProperty({ description: 'The ID of the office', example: 'office-uuid-123' })
  @IsString()
  @IsNotEmpty()
  officeId: string;

  @ApiProperty({ description: 'The ID of the task', example: 'task-uuid-123' })
  @IsString()
  @IsNotEmpty()
  taskId: string;
  ...
  @ApiProperty({ description: 'The old value before the change', example: 'TODO', required: false })
  @IsString()
  @IsOptional()
  oldValue?: string;

  @ApiProperty({ description: 'The new value after the change', example: 'IN_PROGRESS', required: false })
  @IsString()
  @IsOptional()
  newValue?: string;
